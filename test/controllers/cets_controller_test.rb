...
class CetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cet" do
    assert_difference('Cet.count') do
      post cets_url, params: { cet: { exercise_id: @cet.exercise_id, repetition: @cet.repetition, weight: @cet.weight } }
    end
  ...
  test "should update cet" do
    patch cet_url(@cet), params: { cet: { exercise_id: @cet.exercise_id, repetition: @cet.repetition, weight: @cet.weight } }
